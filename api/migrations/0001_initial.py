...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Person',
            fields=[
                ('sin', models.PositiveIntegerField(primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            name='Material',
            fields=[
                ('material_no', models.PositiveIntegerField(primary_key=True, serialize=False)),
                ('name', models.CharField(max_length=255)),
        ...
        migrations.CreateModel(
            name='Assignment',
            fields=[
                ('assign_no', models.PositiveIntegerField(primary_key=True, serialize=False)),
                ('name', models.CharField(max_length=255)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('staff_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='api.staff')),
                ('counsels', models.ManyToManyField(blank=True, to='api.Student')),
            ],
            options={
                'abstract': False,
                'base_manager_name': 'objects',
